...
const DEFAULT_PAPER_CONFIG = [
  {
    "id": "paper1",
    "name": "3楼小组-1：350克 A级铜版纸 双面过哑胶（厚度0.38mm）",
    "shortName": "350铜版纸",
  ...
  {
    "id": "paper2",
    "name": "3楼小组-2：400克 A级铜版纸 双面过哑胶（厚度0.45mm）",
    "shortName": "400铜版纸",
    "priceListId": "priceList2",
    "discount": 0.91,
    "directCoeff": {
  ...
  {
    "id": "paper3",
    "name": "3楼小组-3：702克 A级铜版纸 双面过哑胶（厚度0.85mm）",
    "shortName": "702铜版纸",
    "priceListId": "priceList2",
    "discount": 1,
    "directCoeff": {
  ...
  {
    "id": "paper5",
    "name": "3楼小组-5：500克 白卡纸（厚度0.55mm）正面过哑胶",
    "shortName": "500白卡纸",
    "priceListId": "priceList2",
    "discount": 0.75,
    "directCoeff": {
  ...
  {
    "id": "paper6",
    "name": "3楼小组-6：400克米白卡 / 160克半透卡 / 200克合成纸（海成专用 / 撕不烂）",
    "shortName": "海成专用",
    "priceListId": "priceList2",
    "discount": 0.75,
    "directCoeff": {
  ...
  {
    "id": "paper7",
    "name": "3楼小组-7：700克 A级布纹纸 双面过光油（厚度0.85mm）",
    "shortName": "700布纹纸",
    "priceListId": "priceList2",
    "discount": 1,
    "directCoeff": {
  ...
  {
    "id": "paper8",
    "name": "3楼小组-8：600克 A级牛皮纸（厚度0.80mm）",
    "shortName": "600牛皮纸",
    "priceListId": "priceList2",
    "discount": 0.75,
    "directCoeff": {
 ...
 */
let SHIPPING_CONFIG = [
  { id: "region1", name: "广东省内", basePrices: { 500: 8, 1000: 8, 2000: 13, 5000: 19, 10000: 26 }, overTierCoeff: 1 },
  { id: "region2", name: "福建、浙江、上海、江苏、湖南、安徽", basePrices: { 500: 20, 1000: 20, 2000: 27, 5000: 32, 10000: 42 }, overTierCoeff: 1.2 },
  { id: "region3", name: "湖北、江西、广西", basePrices: { 500: 20, 1000: 20, 2000: 27, 5000: 32, 10000: 42 }, overTierCoeff: 1.3 },
  { id: "region4", name: "河南、河北、天津、山东、山西、陕西", basePrices: { 500: 26, 1000: 26, 2000: 34, 5000: 42, 10000: 50 }, overTierCoeff: 1.7 },
  { id: "region5", name: "云南、贵州、重庆、四川", basePrices: { 500: 26, 1000: 26, 2000: 34, 5000: 42, 10000: 50 }, overTierCoeff: 1.7 },
  { id: "region6", name: "海南、北京", basePrices: { 500: 35, 1000: 35, 2000: 42, 5000: 52, 10000: 62 }, overTierCoeff: 2 },
  { id: "region7", name: "内蒙古、吉林、辽宁、甘肃、宁夏", basePrices: { 500: 40, 1000: 40, 2000: 47, 5000: 57, 10000: 67 }, overTierCoeff: 2.5 },
  { id: "region8", name: "黑龙江、青海", basePrices: { 500: 40, 1000: 40, 2000: 47, 5000: 57, 10000: 67 }, overTierCoeff: 3 },
  { id: "region9", name: "新疆、西藏", basePrices: { 500: 40, 1000: 40, 2000: 47, 5000: 57, 10000: 67 }, overTierCoeff: 4 }
];
...
(function migrateV8Restructure() {
  ...
  const isOld = PRICE_LISTS.length > 2
    ...
    || PRICE_LISTS.some(p => !/楼/.test(p.name || ""));
  if (!isOld) return;
